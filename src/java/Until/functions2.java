...
public class functions2 {
    ...
    public  String uploadJPGRedimencionafotos(String parameter,String path_upload)throws Exception{
        String saveFile=null;
        try{
            saveFile=uploadJPG(parameter,path_upload);
            saveFile=redimencionaImagensfotos(path_upload, saveFile);
        }catch(Exception erro){new Exception(erro.getMessage());}
        return saveFile;
    } 
    public  String uploadJPGRedimencionaFotosPaginas(String parameter,String path_upload)throws Exception{
        String saveFile=null;
        try{
            saveFile=uploadJPG(parameter,path_upload);
            saveFile=redimencionaImagensfotos(path_upload,saveFile);
    ...
    public  String uploadJPGRedimencionaFotosEnsaio(String parameter,String path_upload)throws Exception{
        String saveFile=null;
        try{
            saveFile=uploadJPG(parameter,path_upload);
            saveFile=redimencionaImagensfotosEnsaio(path_upload,saveFile);
        }catch(Exception erro){new Exception(erro.getMessage());}
        return saveFile;
    }
    ...
    public static String uploadRedimencionaFotosPaginas(String path_upload,String endereco){
        ...
        if(endereco!=null){
            ...
            if (arquivo.exists()){
                try{
                    ...
                    //altura largura
                    redimensionarImagem(path_upload+acc+endereco,path_upload +acc+"p_"+novo_endereco,100,100,false);
                    //width="510" height="279"
                    redimensionarImagem(path_upload+acc+endereco,path_upload +acc+"m_"+novo_endereco,279,510,false);
                    redimensionarImagem(path_upload+acc+endereco,path_upload +acc+"g_"+novo_endereco,100,100,false);
                    redimensionarImagem(path_upload+acc+endereco,path_upload +acc+"h_"+novo_endereco,800,750,false);
                    arquivo.delete();
                }
                catch(Exception erro){
                    novo_endereco=null;
    ...
    public static String redimencionaImagensfotos(String path_upload,String endereco){
        String novo_endereco = endereco;
        if(endereco!=null){
            Date tempo = new Date();
            novo_endereco="p_"+(int)tempo.getTime()+"."+getExtension(novo_endereco);
    ...
    public static String redimencionaImagensfotosEnsaio(String path_upload,String endereco){
        String novo_endereco = endereco;
        if(endereco!=null){
            Date tempo = new Date();
            novo_endereco="p_"+(int)tempo.getTime()+"."+getExtension(novo_endereco);
    ...
    public static String UTF_8(String dado){
        try{
            byte[] acc=dado.getBytes();
            dado=new String(acc,"UTF-8");
        }
        catch(Exception erro){
        }
        return dado;
